...
router.get('/active-requests', async (req: any, res: any) => {
    try {
...
router.patch('/availability', (req: any, res: any) => {
...
// Complete a ride
router.post('/complete-ride', async (req: any, res: any) => {
    try {
...
router.post('/respond-ride', async (req: any, res: any) => {
    try {
...
router.patch('/profile/:id', async (req: any, res: any) => {
    try {
